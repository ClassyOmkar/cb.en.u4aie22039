"""
Script to test the Average Calculator API and generate example outputs.
...
ENDPOINTS = {
    "health": "/",
    "prime_numbers": "/numbers/p",
    "fibonacci_numbers": "/numbers/f",
    "even_numbers": "/numbers/e",
    "random_numbers": "/numbers/r"
}
...
def main():
    """Test all endpoints of the Average Calculator API."""
    print("TESTING AVERAGE CALCULATOR API")
